      ...
      items: [
        BottomNavigationBarItem(
          icon: Image.asset(
            ...
            color: _currentIndex==0?primaryColor:bottomNavigationIconColor,
            width: 24,
          ),
          label: "편지",
        ),
        BottomNavigationBarItem(
          icon: Image.asset(
            ...
            color: _currentIndex==1?primaryColor:bottomNavigationIconColor,
            width: 22,
          ),
          label: "채팅",
        ),
        BottomNavigationBarItem(
          icon: Image.asset(
            ...
            color: _currentIndex==2?primaryColor:bottomNavigationIconColor,
            width: 22,
          ),
          label: "홈",
        ),
        BottomNavigationBarItem(
          icon: Image.asset(
            ...
            color: _currentIndex==3?primaryColor:bottomNavigationIconColor,
            width: 22,
          ),
          label: "뉴스레터",
        ),
        BottomNavigationBarItem(
          icon: Image.asset(
            ...
            color: _currentIndex==4?primaryColor:bottomNavigationIconColor,
            width: 20,
          ),
          label: "테스트",
        ),
